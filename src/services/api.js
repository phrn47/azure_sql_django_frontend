...
const api = axios.create({
  baseURL: import.meta.env.VITE_API_URL || 'https://pharun-backend-hhdudzemehdnfvhu.japanwest-01.azurewebsites.net/api',
...
const FUNCTION_API_URL = 'https://porfunctioncontent-hvdgfvbth8h5gzfn.japanwest-01.azurewebsites.net/api';
